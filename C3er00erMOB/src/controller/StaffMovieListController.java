...
public class StaffMovieListController {
	...
	/**
	 * This function allow staff to add movie into movielist addMovieList and
	 * addReviewList function will be called at the end of the function to ensure
	 * that both movielist and review csv is updated
	 * 
	...
	public static boolean staffUpdateStatus(List<Movie> mList) {
		...
		for (int i = 0; i < mList.size(); i++) {
			System.out.println(
					i + 1 + ". " + mList.get(i).getMovieTitle() + " [" + mList.get(i).getStatus().toString() + "]");
		}
